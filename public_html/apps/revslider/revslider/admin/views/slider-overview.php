...
<div class='wrap'>
	...
	<div class="rs-dashboard">	
		...
		?>
		<div style="display: none" class="rs-dash-widget" id="updates_dw">
		...
		<div style="display: none" class="rs-dash-widget" id="system_dw">
			<?php
				$dir = wp_upload_dir();				
		...
		TEMPLATE WIDGET
		-->
		<div style="display: none" id="templates_dw" class="rs-dash-widget">
		...
		NEWSLETTER
		-->
		<div style="display: none" class="rs-dash-widget" id="newsletter_dw">
		...
		PRODUCT SUPPORT
		-->
		<div style="display: none" class="rs-dash-widget" id="support_dw">
			<div class="rs-dash-title-wrap">
	...
	<div class="rs-update-history-wrapper" style="display: none">
		<div class="rs-dash-title-wrap">
