<div id="navigation">
	<ul id="user">
		<li class="slider-overview" style="display: none"><?php _e('Hello'); ?>, <?php echo $user['username']; ?>!</li>
        <li>
