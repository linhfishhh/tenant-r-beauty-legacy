...
@section('page_content')
    ...
    <div class="search-page-header common-page-header" style="background-image: url('{!! $headline_bg !!}')">
        <div class="container">
            <div class="wrapper">
                <div class="inner">
                ...
                <div class="col-md-4">
                    ...
                    <div class="filter-section">
                        ...
                        if($location_lv){
                            ...
                            if($location){
                                if($location_lv == 1){
                                    if($location_info = \Modules\ModHairWorld\Entities\DiaPhuongTinhThanhPho::whereIn('id', $location)->get()){
                                        $has_search = true;
                                    }
                                }
                                elseif($location_lv == 2){
                                    if($location_info = \Modules\ModHairWorld\Entities\DiaPhuongQuanHuyen::whereIn('id', $location)->get()){
                                        $has_search = true;
                                    }
                                }
                                elseif($location_lv == 3){
                                    if($location_info = \Modules\ModHairWorld\Entities\DiaPhuongXaPhuongThiTran::whereIn('id', $location)->get()){
                                        $has_search = true;
                                    }
                                }
                            }
                        ...
                        @php
                            ...
                            if($cats){
                                $cats = \Modules\ModHairWorld\Entities\SalonServiceCategory::whereIn('id', $cats)->get();
                                $has_search = true;
                            }
                        @endphp
...
@push('page_footer_js')
    ...
    <script type="text/javascript">
        ...
        $(function () {
                ...
                $.ajax({
                    ...
                    success: function (json) {
                        if(json.hasOwnProperty('result')){
                            ...
                            if(page == 1){
                                fetchCats(form, data, json);
                                fetchLocations(form, data, json);
                            }
            ...
            function fetchCats(form, data, json) {
                $.ajax({
                    url: '{!! route('frontend.searchv2.cats') !!}',
                    type: 'get',
                    dataType: 'json',
                    data: data,
                    success: function (cats) {
                        ...
                        if(cats.length != 0){
                            ...
                            $(cats).each(function () {
                                ...
                                tpl = tpl.replace(/{title}/g, this.title.toLowerCase());
            ...
            function fetchLocations(form, data, json){
                $.ajax({
                    url: '{!! route('frontend.searchv2.locations') !!}',
                    type: 'get',
                    dataType: 'json',
                    data: data,
            ...
            $('#filter-form').submit(
                function () {
                    ...
                    window.history.pushState(null,null, '{!! route('frontend.searchv2') !!}?'+url);
                    loadSearchResult(1);
                    return false
                }
            );
