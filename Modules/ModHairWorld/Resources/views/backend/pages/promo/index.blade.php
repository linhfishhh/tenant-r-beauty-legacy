...
@section('page_title', 'Salon tham gia campaign')
@section('page_header_title')
    <strong>Salon tham gia campaign</strong>
@endsection
...
@section('page_content_body')
    ...
    <div class="panel panel-white">
        <div class="panel-heading">
            <h6 class="panel-title text-teal text-semibold">{!! __('SALON THAM GIA') !!}</h6>
        </div>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $modal_add.find('form').submit(function(){
                ...
                var url = '{!! route('backend.promo_salons.add', ['salon'=>'???']) !!}';
                ...
                $.ajax({
                    ...
                    success: function (json) {
                        ...
                        if(json){
                            ...
                            new PNotify({
                                title: '{{'LƯU DỮ LIỆU'}}',
                                text: '{{__('Salon này đã nằm trong danh sách tham gia khuyến mãi rồi')}}',
                                addclass: 'bg-danger stack-bottom-right',
                                stack: {"dir1": "up", "dir2": "left", "firstpos1": 25, "firstpos2": 25},
                                buttons: {
                                    sticker: false
            ...
            var $options = {
                ...
                autoWidth: false,
                search: false,
                ajax: '{!! route('backend.promo_salons.index') !!}',
                columns: [],
                columnDefs: []
            };
