...
@enqueueJS('star-rating', getThemeAssetUrl('libs/star-rating/js/simple-rating.js'), JS_LOCATION_HEAD, 'jquery')
@enqueueCSS('star-rating', getThemeAssetUrl('libs/star-rating/css/simple-rating.css'), 'bootstrap')
...
@php
    ...
    $og_height = 500;
@endphp
@extends(getThemeViewName('master_bm'))
@push('page_meta')
    ...
    <div id="news-block" class="d-none">
        <div class="container">
            <div class="block-title">
                Bài viết mới nhất
                <div class="link">
                    <a target="_blank" href="https://blog.isalon.vn">Xem tất cả ></a>
                </div>
            </div>
...
@push('page_footer_js')
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            $.ajax({
                url: 'https://blog.isalon.vn/api/get_recent_posts',
                type: 'get',
                dataType: 'json',
