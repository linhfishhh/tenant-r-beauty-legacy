    ...
    ] ,function ()
    {
        Route::middleware( 'scopes:manager')->group(function (){
            ...
            Route::middleware(\Modules\ModHairWorld\Http\Middleware\AutoGetSalon::class)->group(function(){
                ...
                Route::get('edit-salon/service/{service}/options', 'Modules\ModHairWorld\Http\Controllers\ApiManager\ScreenController@serviceOptions');

                Route::get('edit-salon/service/{service}/option/{option}/info', 'Modules\ModHairWorld\Http\Controllers\ApiManager\ScreenController@OptionInfo');

                Route::post('edit-salon/service/{service}/option/{option}/update', 'Modules\ModHairWorld\Http\Controllers\ApiManager\ScreenController@OptionUpdate');

                Route::post('edit-salon/service/{service}/option/create', 'Modules\ModHairWorld\Http\Controllers\ApiManager\ScreenController@optionCreate');

                Route::post('edit-salon/service/{service}/option/{option}/remove', 'Modules\ModHairWorld\Http\Controllers\ApiManager\ScreenController@optionRemove');
